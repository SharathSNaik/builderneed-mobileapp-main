(function () {
  ...
  var builderneedWindow = $(window);
  var sideNavWrapper = $("#sidenavWrapper");
  var blackOverlay = $(".sidenav-black-overlay");

  // :: Preloader
  builderneedWindow.on("load", function () {
    $("#preloaders").fadeOut("3000", function () {
      $(this).remove();
    });
  });

  // :: Navbar
  $("#builderneedNavbarToggler").on("click", function () {
  ...
  // :: Dropdown Menu
  $(".sidenav-nav")
    .find("li.builderneed-dropdown-menu")
    .append(
