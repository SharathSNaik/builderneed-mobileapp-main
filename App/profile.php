...
<html lang="en">
<!--head and meta tags-->
<title>My Profile - <?php echo $name['name']; ?> </title>
                ...
                <div class="card user-info-card">
                    <div class="card-body p-4 d-flex align-items-center">
                        <div class="user-profile mr-3">
                            ...
                            <!-- <img class="dataprof" src="../assets/img/features/user-profile.png" alt=""> -->
                            <div class="change-user-thumb">
                                <!-- <form method="post" enctype="multipart/form-data" name="fileToUpload" id="fileToUpload">
