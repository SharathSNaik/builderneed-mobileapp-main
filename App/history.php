...
<body>
        ...
        <div class="modal-dialog" role="document" style="margin-top: 50%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-comments"></i> Conversations</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body updateConvo">
                    <center>
                        <img class='loadconv' src='../assets/img/loadingio.gif' />
                    </center>
                </div>
            </div>
        </div>
    ...
    <script src="source/js/history-summary.js"></script>
    <!-- END -->
</body>
