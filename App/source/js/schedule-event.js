...
var email_v = "";
var phone_v = "";
var sourceevent = "Google Meet";
var getVisitID = "";
$(document).ready(function () {
  var gettoday = new Date();
  var day = gettoday.toLocaleDateString(gettoday.getTimezoneOffset(), {
    day: "numeric",
  });
  $(".findactive").hide();
  $(".callinfo").slick();
...
function getDatemonth(e) {
  if ($(".days").find("a").hasClass("text-white")) {
    $("a").removeClass("text-white");
    $("a").removeClass("font-weight-bold");
    $("a").removeClass("bg-secondary");
    $(e).addClass("text-white font-weight-bold  bg-secondary");
  } else {
    $(e).attr("class", "text-white font-weight-bold bg-secondary");
  }
  var d = new Date();
