...
if ($getVisitID) {
    ...
    if ($count == 1) {
        ...
        $queryEvent = mysqli_query($connection, "INSERT INTO bn_site_visit_info (agent,lp_id,visit_date,created_date,requested_mode,email,phone,meetingstatus,visit_source,sr_id)VALUES('$id','$lid','$getdatetime','$currentdate','$getmode','$email','$number','$status','$sourceevent','$srid')");
        if ($queryEvent) {
