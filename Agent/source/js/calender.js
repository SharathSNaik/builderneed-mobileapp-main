...
var monthurl = url.searchParams.get("month");
var yearurl = url.searchParams.get("year");
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $cal.responsiveCalendar({}); /* end $cal */
  }); /* end $document */
...
(function () {
  (function (c) {
    ...
    d = function (f, e) {
      ...
      this.time = new Date();
      if (dateurl == "" || dateurl == undefined) {
        this.currentYear = this.time.getFullYear();
        this.currentMonth = this.time.getMonth();
      } else {
        this.currentYear = Number(yearurl);
        this.currentMonth = Number(monthurl)-1;
      }
      ...
      drawDay: function (o, p, j, f, h) {
        ...
        l.append(
          c("<a>" + f + "</a>")
            ...
            .attr("data-month", j)
            .attr("data-year", p)
            .attr("onClick", "getDatemonth(this);")
        );
